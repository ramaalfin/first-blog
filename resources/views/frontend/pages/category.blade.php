                    ...
                    <div class="col-md-9" data-aos="fade-up">
                        ...
                        @foreach ($posts as $post)
                            <div class="d-md-flex post-entry-2 half">
                                <a href="{{ route('single-post', ['post' => $post->id]) }}" class="me-4 thumbnail">
                                    <img src="{{ url('frontend/assets/img/post-landscape-6.jpg') }}" alt=""
                                        class="img-fluid">
                                </a>
                                <div>
                                    <div class="post-meta"><span class="date">{{ $post->category->name }}</span> <span
                                            class="mx-1">&bullet;</span>
                                        <span>{{ $post->created_at->isoFormat('D MMMM YYYY') }}</span></div>
                                    <h3><a href="{{ route('single-post', ['post' => $post->id]) }}">{{ $post->title }}</a>
                                    </h3>
                                    <p>{!! Str::limit($post->description, 300, '....') !!}</p>
                                    <div class="d-flex align-items-center author">
                                        <div class="photo"><img src="{{ url('frontend/assets/img/person-2.jpg') }}"
                        ...
                        <div class="aside-block">
                            ...
                            <div class="video-post">
                                <a href="https://www.youtube.com/watch?v=AiFfDjmd0jU" class="glightbox link-video">
                                    ...
                                    <img src="{{ url('frontend/assets/img/post-landscape-5.jpg') }}" alt=""
                                        class="img-fluid">
                                </a>
                            </div>
                        </div><!-- End Video -->
